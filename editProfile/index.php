    ...
    <nav class="nav navbar-sticky-top top-nav-bar">
        ...
        <div class="col-lg-3">
            <ul class="list-inline">
                <li class="list-inline-item"><button id="getNotifications" class="btn btn-primary">Notifications <span id="notification-count" class="tag">20</span> </button> </li>
                <li class="list-inline-item"><a href="../logout.php"> <button class="btn  btn-outline-primary">Logout</button></a> </li>
            </ul>
        </div>
</div>
</nav>
